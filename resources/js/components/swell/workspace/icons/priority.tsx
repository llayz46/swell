...
export const NoPriorityIcon: FC<PriorityIconProps> = ({
    width = 16,
    height = 16,
    className,
    ...props
...
export const LowPriorityIcon: FC<PriorityIconProps> = ({
    width = 16,
    height = 16,
    className,
    ...props
...
export const MediumPriorityIcon: FC<PriorityIconProps> = ({
    width = 16,
    height = 16,
    className,
    ...props
...
export const HighPriorityIcon: FC<PriorityIconProps> = ({
    width = 16,
    height = 16,
    className,
    ...props
...
export const UrgentPriorityIcon: FC<PriorityIconProps> = ({
    width = 16,
    height = 16,
    className,
    ...props

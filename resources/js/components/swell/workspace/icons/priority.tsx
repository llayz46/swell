...
export interface PriorityIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
    width?: number;
    height?: number;
    className?: string;
}

export const NoPriorityIcon: FC<PriorityIconProps> = ({ width = 16, height = 16, className, ...props }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>
...
export const LowPriorityIcon: FC<PriorityIconProps> = ({ width = 16, height = 16, className, ...props }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>
...
export const MediumPriorityIcon: FC<PriorityIconProps> = ({ width = 16, height = 16, className, ...props }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>
            <rect x="1.5" y="8" width="3" height="6" rx="1"></rect>
...
export const HighPriorityIcon: FC<PriorityIconProps> = ({ width = 16, height = 16, className, ...props }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>
            <rect x="1.5" y="8" width="3" height="6" rx="1"></rect>
            <rect x="6.5" y="5" width="3" height="9" rx="1"></rect>
...
export const UrgentPriorityIcon: FC<PriorityIconProps> = ({ width = 16, height = 16, className, ...props }) => {
    return (
        <svg width={width} height={height} viewBox="0 0 16 16" fill="currentColor" className={className} {...props}>

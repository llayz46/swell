        ...
        <Popover>
            ...
            <PopoverContent className="w-80 p-0" align="end">
                <div className="px-4 pt-3 pb-3">
                    <h3 className="mb-3 text-sm font-medium">Inbox notifications</h3>

                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <label htmlFor="team-issue-added" className="flex-1 cursor-pointer text-xs text-muted-foreground">
                        ...
                        <div className="flex items-center justify-between">
                            <label htmlFor="issue-completed" className="flex-1 cursor-pointer text-xs text-muted-foreground">
                        ...
                        <div className="flex items-center justify-between">
                            <label htmlFor="issue-triage" className="flex-1 cursor-pointer text-xs text-muted-foreground">

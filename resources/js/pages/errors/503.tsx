        ...
        <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-background px-4">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <TextAnimate animation="fadeIn" by="line" delay={0.3} className="mb-10 max-w-md text-muted-foreground">
                    Le site est temporairement indisponible pour maintenance. Nous travaillons pour améliorer votre expérience. Revenez dans
                    quelques minutes.
                </TextAnimate>
                ...
                <p className="mt-8 text-sm text-muted-foreground">Merci de votre patience</p>
            </div>
